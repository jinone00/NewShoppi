...
class HomeBannerAdapter : ListAdapter<Banner, HomeBannerAdapter.HomeBannerViewHolder>(BannerDiffCallback()) {
    ...
    class HomeBannerViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        private val bannerDetailProductDetailTextView = view.findViewById<TextView>(R.id.tv_banner_detail_product_label)
        ...
        fun bind(banner: Banner){
            ...
            bannerDetailProductDetailTextView.text = banner.productDetail.label
